//
//  AlbumTypeTwoCollectionViewCell.m
//  Welko
//
...
@implementation AlbumTypeTwoCollectionViewCell
...
//单击手势
- (void)tapToDo:(UILongPressGestureRecognizer *)gesture{

    if (self.returnTapToDoBlock) {
        
        self.returnTapToDoBlock();
    }
}
